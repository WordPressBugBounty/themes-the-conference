...
const pluginList = [
    {
        pluginName: __('RaraTheme Companion', 'the-conference'),
        description: __("23 extremely useful custom widgets to create an engaging website.", "the-conference"),
        slug: "raratheme-companion"
    },
    {
        pluginName: "BlossomThemes Email Newsletter",
        description: __("Easily add email subscription form to your website using shortcode and widget.", "the-conference"),
        slug: "blossomthemes-email-newsletter"
    },
    {
        pluginName: "Regenerate Thumbnails",
        description: __("Regenerate the thumbnails for one or more of your image uploads. Useful when changing their sizes or your theme.", "the-conference"),
        slug: "regenerate-thumbnails"
    },
    {
        pluginName: "Smash Balloon Social Photo Feed",
        description: __("Formerly 'Instagram Feed'. Display clean, customizable, and responsive Instagram feeds from multiple accounts. Supports Instagram oEmbeds.", "the-conference"),
        slug: "instagram-feed"
    },
    {
        pluginName: __('Rara One Click Demo Import', 'the-conference'),
        description: __("Make your website look like the live demo of the theme with a click!", "the-conference"),
